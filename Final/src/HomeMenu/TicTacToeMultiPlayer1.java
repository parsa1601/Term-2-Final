...
public class TicTacToeMultiPlayer1 {
    ...
    public static void display(String  username , String contact){
        ...
        table[0].setOnMouseClicked(mouseEvent -> {
            if(access[0]) {
                if (tapMethod(username, contact).equals("can")) {
                    gameBoard.getBoard()[0] = USER;
                    xSigns[0].setVisible(true);
                    sendMethod(username , contact , 0 , USER);
                    int result = setBlue(username, contact);
        ...
        table[1].setOnMouseClicked(mouseEvent -> {
            if(access[1]) {
                if (tapMethod(username, contact).equals("can")) {
                    ...
                    sendMethod(username , contact , 1 , USER);
                    int result = setBlue(username, contact);
                    gameBoard.getBoard()[result]= BOT;
                    access[result] = false;
                    oSigns[result].setVisible(true);
        ...
        table[2].setOnMouseClicked(mouseEvent -> {
            if(access[2]){
                if (tapMethod(username, contact).equals("can")) {
                    ...
                    sendMethod(username , contact , 2 , USER);
                    int result = setBlue(username, contact);
                    gameBoard.getBoard()[result]= BOT;
                    access[result] = false;
                    oSigns[result].setVisible(true);
        ...
        table[3].setOnMouseClicked(mouseEvent -> {
            if(access[3]){
                if (tapMethod(username, contact).equals("can")) {
                    ...
                    sendMethod(username , contact , 3 , USER);
                    int result = setBlue(username, contact);
                    gameBoard.getBoard()[result]= BOT;
                    access[result] = false;
                    oSigns[result].setVisible(true);
        ...
        table[4].setOnMouseClicked(mouseEvent -> {
            if(access[4]){
                if (tapMethod(username, contact).equals("can")) {
                    ...
                    sendMethod(username , contact , 4 , USER);
                    int result = setBlue(username, contact);
                    gameBoard.getBoard()[result]= BOT;
                    access[result] = false;
                    oSigns[result].setVisible(true);
        ...
        table[5].setOnMouseClicked(mouseEvent -> {
            if(access[5]) {
                if (tapMethod(username, contact).equals("can")) {
                    ...
                    sendMethod(username , contact , 5 , USER);
                    int result = setBlue(username, contact);
                    gameBoard.getBoard()[result]= BOT;
                    access[result] = false;
                    oSigns[result].setVisible(true);
        ...
        table[6].setOnMouseClicked(mouseEvent -> {
            if (access[6]) {
                if (tapMethod(username, contact).equals("can")) {
                    ...
                    sendMethod(username , contact , 6 , USER);
                    int result = setBlue(username, contact);
                    gameBoard.getBoard()[result]= BOT;
                    access[result] = false;
                    oSigns[result].setVisible(true);
        ...
        table[7].setOnMouseClicked(mouseEvent -> {
            if(access[7]){
                if (tapMethod(username, contact).equals("can")) {
                    ...
                    sendMethod(username , contact , 7 , USER);
                    int result = setBlue(username, contact);
                    gameBoard.getBoard()[result]= BOT;
                    access[result] = false;
                    oSigns[result].setVisible(true);
        ...
        table[8].setOnMouseClicked(mouseEvent -> {
            if(access[8]){
                if (tapMethod(username, contact).equals("can")) {
                    ...
                    sendMethod(username , contact , 8 , USER);
                    int result = setBlue(username, contact);
                    gameBoard.getBoard()[result]= BOT;
                    access[result] = false;
                    oSigns[result].setVisible(true);
...
//    }
    ...
    private static String tapMethod(String username , String contact){
        String massageHeader = "TTT :" + "User: " + username + "Cont: " + contact + "# ";
        massageHeader += "turn";
        String result = null;
        try {
    ...
    private static void sendMethod(String username , String contact , int home, int sign){
        String massageHeader = "TTT :" + "User: " + username + "Cont: " + contact + "# ";
        massageHeader += home+sign;
        String result = null;
        try {
            Socket socket = new Socket("127.0.0.1", 8889);
            DataOutputStream dataOutputStream = new DataOutputStream(new BufferedOutputStream(socket.getOutputStream()));
    ...
    private static int setBlue(String username, String contact) {
        try {
            FileReader file = new FileReader ("src/HomeMenu/Users/Info/" + contact + " /Game/TTT/" + username + " .txt");
            ...
            char chOfHome = lastLine.charAt( lastLine.indexOf(":") + 2 );

            if (!lastLine.startsWith(username) && chOfHome != 'd') return Integer.parseInt(String.valueOf(chOfHome));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return 'z';
