...
public class SnakeNLadderMultiPlayer2 {
    ...
    public static void display(String yesNo , String username , String contact){
        ...
        Text player1 = new Text(33,20,"Opponent");
        player1.setFill(Color.RED);
        player1.setVisible(false);

        Text player2 = new Text(308,20,"Player");
        ...
        tapToDice.setOnMouseClicked(mouseEvent -> {
            ...
            if (tapToDiceMethod(username, contact).equals("can")) {
                ...
                System.out.println("rp:" + bluePlace);
                diceChenger(diceComputer, number);
                placesBlue[bluePlace].setVisible(false);
                bluePlace += number;
                System.out.println("rp2:" + bluePlace);
                ...
                if (!(enemyNumber == -1)){
                    ...
                    diceChenger(dicePlayer , enemyNumber);
                    placesRed[redPlace].setVisible(false);
                    redPlace += enemyNumber;
                    System.out.println("bp2:" + redPlace);
